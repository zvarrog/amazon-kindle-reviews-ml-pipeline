...
def setup_test_environment(tmp_path_factory):
    ...
    os.environ.setdefault("AIRFLOW_HOME", str(base_tmp / "airflow_test"))
    os.environ.setdefault("RAW_DATA_DIR", str(base_tmp / "data" / "raw"))
    os.environ.setdefault("PROCESSED_DATA_DIR", str(base_tmp / "data" / "processed"))
    os.environ.setdefault("MODEL_DIR", str(base_tmp / "models"))
