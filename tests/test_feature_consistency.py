...
def test_features_on_raw_text():
    ...
    features = extract_pandas_features(df_raw)
...
class TestEdgeCases:
    ...
    def test_empty_string(self):
        ...
        features = extract_pandas_features(pd.Series([""]))
    ...
    def test_very_long_text(self):
        ...
        features = extract_pandas_features(pd.Series([long_text]))
    ...
    def test_special_characters_only(self):
        ...
        features = extract_pandas_features(pd.Series([text]))
    ...
    def test_mixed_case_consistency(self):
        ...
        features_lower = extract_pandas_features(pd.Series([lower]))
        features_upper = extract_pandas_features(pd.Series([upper]))
