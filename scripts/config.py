...
# Потенциальная точка отказа: имя может измениться
...
SHUFFLE_PARTITIONS = _getenv_int("SHUFFLE_PARTITIONS", 8)
...
SPARK_NUM_CORES = _getenv_int("SPARK_NUM_CORES", 2)
...
@dataclass
class DataPaths:
    """Пути к обработанным данным (train/val/test splits)."""
