...
from scripts.project_types import (
    BaselineStats,
    HealthStatus,
    MetadataResponse,
    ModelInfo,
...
class ModelService:
    ...
    def model_name(self) -> str:
        """Возвращает имя загруженной модели."""
    ...
    def get_metadata(self) -> MetadataResponse:
        ...
        model_info: ModelInfo = {
            ...
            "test_metrics": dict(self.meta.get("test_metrics", {})),  # type: ignore[typeddict-item]
            "training_duration_sec": float(training_duration) if training_duration else None,
            "dataset_sizes": dict(dataset_sizes),  # type: ignore[typeddict-item]
        }
        ...
        return {
            ...
            "feature_contract": feature_info,  # type: ignore[typeddict-item]
            "health": health,
        }
