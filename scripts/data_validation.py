...
class DataSchema:
    ...
    text_constraints: dict[str, dict[str, Any]]
...
def validate_parquet_file(
    ...
    try:
        ...
        safe_dtypes = {col: str(dtype) for col, dtype in df.dtypes.items()}
        ...
        if "reviewText" in df.columns:
            text_lengths = df["reviewText"].astype(str).str.len()
            schema_info["text_stats"] = {
